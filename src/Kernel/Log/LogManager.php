...
class LogManager implements LoggerInterface
{
     ...
     *
     * @param \Gather\Kernel\ServiceContainer $app
     */
    ...
    {
        return new Monolog('Gather', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir().'/gather/Gather.log',
